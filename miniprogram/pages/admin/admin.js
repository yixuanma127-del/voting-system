    ...
    try {
      ...
      const processed = works.map(w => ({
        ...
        image_data: w.image_data
          ? (w.image_data.startsWith('data:') ? w.image_data : 'data:image/jpeg;base64,' + w.image_data)
          : ''
      }))
    ...
    try {
      ...
      const processed = results.map(r => ({
        ...
        image_data: r.image_data
          ? (r.image_data.startsWith('data:') ? r.image_data : 'data:image/jpeg;base64,' + r.image_data)
          : ''
      }))
